...
cutoff_frequency = 10;
[low_frequencies_dog1,low_frequencies_cat1] = gen_hybrid_image_fft( image1, image2, cutoff_frequency, 1 );
[low_frequencies_dog2,low_frequencies_cat2] = gen_hybrid_image_fft( image1, image2, cutoff_frequency, 2 );
[low_frequencies_dog3,low_frequencies_cat3] = gen_hybrid_image_fft( image1, image2, cutoff_frequency, 3 );
low_frequencies_dog = cat(3, low_frequencies_dog1, low_frequencies_dog2, low_frequencies_dog3);
low_frequencies_cat = cat(3, low_frequencies_cat1,low_frequencies_cat2, low_frequencies_cat3);

high_frequencies = image2 - low_frequencies_cat;
low_frequencies = low_frequencies_dog;
...
imwrite(high_frequencies + 0.5, 'high_frequencies.jpg');
