...
large_blur_image = my_imfilter(test_image, gaussian_kernel);
large_blur_image = my_imfilter(large_blur_image, gaussian_kernel'); %notice the ' operator which transposes the filter
